 ...
 */
@Component
public class CircuitTrigger {

    private static final Logger log = LoggerFactory.getLogger(CircuitTrigger.class);

    private final CircuitBreakerStateMapper stateMapper;
    private final ModelService modelService;
    private final ChannelApiKeyService channelApiKeyService;

    public CircuitTrigger(CircuitBreakerStateMapper stateMapper,
